...
- 🅼 [magicm\.deploy](#magicm-deploy)
- 🅼 [magicm\.deploy\.enviroment](#magicm-deploy-enviroment)
- 🅼 [magicm\.deploy\.enviroment\.env\_manage](#magicm-deploy-enviroment-env_manage)
- 🅼 [magicm\.deploy\.enviroment\.env\_setup](#magicm-deploy-enviroment-env_setup)
- 🅼 [magicm\.deploy\.enviroment\.env\_uv\_installer](#magicm-deploy-enviroment-env_uv_installer)
...
- 🅼 [magicm\.detector\.hardware\.gpu\.gpu\_detector](#magicm-detector-hardware-gpu-gpu_detector)
...
- 🅼 [magicm\.detector\.software\.environment](#magicm-detector-software-environment)
- 🅼 [magicm\.detector\.software\.environment\.env\_detecter](#magicm-detector-software-environment-env_detecter)
...
- 🅼 [magicm\.management\.config\.config\_loader](#magicm-management-config-config_loader)
- 🅼 [magicm\.management\.config\.config\_manager](#magicm-management-config-config_manager)
- 🅼 [magicm\.management\.config\.config\_path\_manager](#magicm-management-config-config_path_manager)
- 🅼 [magicm\.management\.config\.config\_reader](#magicm-management-config-config_reader)
- 🅼 [magicm\.management\.config\.config\_writer](#magicm-management-config-config_writer)
...
- **Functions:**
  - 🅵 [setup](#magicm-command-deploy-setup)

### Functions

<a name="magicm-command-deploy-setup"></a>
### 🅵 magicm\.command\.deploy\.setup
...
- **Classes:**
  - 🅲 [DetectCommand](#magicm-command-detecter-DetectCommand)
...
<a name="magicm-command-detecter-DetectCommand"></a>
### 🅲 magicm\.command\.detecter\.DetectCommand
...
<a name="magicm-command-detecter-DetectCommand-__init__"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.\_\_init\_\_
...
初始化检测命令
<a name="magicm-command-detecter-DetectCommand-get_env_info"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.get\_env\_info
...
获取虚拟环境信息
<a name="magicm-command-detecter-DetectCommand-get_system_info"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.get\_system\_info
...
获取系统信息
<a name="magicm-command-detecter-DetectCommand-get_cpu_info"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.get\_cpu\_info
...
获取CPU信息
<a name="magicm-command-detecter-DetectCommand-get_gpu_info"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.get\_gpu\_info
...
获取GPU信息
<a name="magicm-command-detecter-DetectCommand-get_memory_info"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.get\_memory\_info
...
获取内存信息
<a name="magicm-command-detecter-DetectCommand-detect"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.detect
...
主函数：顺序调用各检测模块，然后交给 display 显示
<a name="magicm-command-detecter-DetectCommand-display"></a>
#### 🅵 magicm\.command\.detecter\.DetectCommand\.display
...
- **Classes:**
  - 🅲 [DisplayCommand](#magicm-command-display-DisplayCommand)
...
```python
def create_display(config_path: Optional[str] = None) -> DisplayCommand:
```
...
<a name="magicm-command-display-DisplayCommand"></a>
### 🅲 magicm\.command\.display\.DisplayCommand
...
<a name="magicm-command-display-DisplayCommand-__init__"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.\_\_init\_\_
...
<a name="magicm-command-display-DisplayCommand-display_all"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.display\_all
...
\{
    ...
    'env': \{\.\.\.\}
\}
<a name="magicm-command-display-DisplayCommand-format_text"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.format\_text
...
- 格式化的文本字符串
<a name="magicm-command-display-DisplayCommand-get_gpu_rating"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.get\_gpu\_rating
...
获取GPU评级
<a name="magicm-command-display-DisplayCommand-get_vram_rating"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.get\_vram\_rating
...
获取显存评级
<a name="magicm-command-display-DisplayCommand-get_driver_rating"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.get\_driver\_rating
...
获取驱动评级
<a name="magicm-command-display-DisplayCommand-get_system_rating"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.get\_system\_rating
...
获取系统评级
<a name="magicm-command-display-DisplayCommand-get_cpu_rating"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.get\_cpu\_rating
...
获取CPU评级
<a name="magicm-command-display-DisplayCommand-get_memory_rating"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.get\_memory\_rating
...
获取内存评级
<a name="magicm-command-display-DisplayCommand-show_banner"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.show\_banner
...
显示欢迎横幅
<a name="magicm-command-display-DisplayCommand-show_footer"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.show\_footer
...
显示页脚
<a name="magicm-command-display-DisplayCommand-reload_config"></a>
#### 🅵 magicm\.command\.display\.DisplayCommand\.reload\_config
...
- **config_path**: 配置文件路径（可选）
<a name="magicm-deploy"></a>
## 🅼 magicm\.deploy
<a name="magicm-deploy-enviroment"></a>
## 🅼 magicm\.deploy\.enviroment
<a name="magicm-deploy-enviroment-env_manage"></a>
## 🅼 magicm\.deploy\.enviroment\.env\_manage

虚拟环境管理器

- **Classes:**
  - 🅲 [EnvManager](#magicm-deploy-enviroment-env_manage-EnvManager)

### Classes

<a name="magicm-deploy-enviroment-env_manage-EnvManager"></a>
### 🅲 magicm\.deploy\.enviroment\.env\_manage\.EnvManager
...
<a name="magicm-deploy-enviroment-env_manage-EnvManager-__init__"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_manage\.EnvManager\.\_\_init\_\_

```python
def __init__(self, name: str, env_root: Path, python_version: str = '3.11'):
```
<a name="magicm-deploy-enviroment-env_manage-EnvManager-exists"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_manage\.EnvManager\.exists
...
检查虚拟环境是否存在
<a name="magicm-deploy-enviroment-env_manage-EnvManager-create"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_manage\.EnvManager\.create
...
创建虚拟环境
<a name="magicm-deploy-enviroment-env_manage-EnvManager-delete"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_manage\.EnvManager\.delete
...
删除虚拟环境
<a name="magicm-deploy-enviroment-env_setup"></a>
## 🅼 magicm\.deploy\.enviroment\.env\_setup

环境一键设置模块

- **Functions:**
  - 🅵 [setup\_env](#magicm-deploy-enviroment-env_setup-setup_env)
  - 🅵 [quick\_setup](#magicm-deploy-enviroment-env_setup-quick_setup)

### Functions

<a name="magicm-deploy-enviroment-env_setup-setup_env"></a>
### 🅵 magicm\.deploy\.enviroment\.env\_setup\.setup\_env

```python
def setup_env(env_name: str, env_path: Path, python_version: str = '3.11', force: bool = False) -> bool:
```
...
- 是否成功
<a name="magicm-deploy-enviroment-env_setup-quick_setup"></a>
### 🅵 magicm\.deploy\.enviroment\.env\_setup\.quick\_setup
...
- 是否成功
<a name="magicm-deploy-enviroment-env_uv_installer"></a>
## 🅼 magicm\.deploy\.enviroment\.env\_uv\_installer

UV 安装器

- **Classes:**
  - 🅲 [UvInstaller](#magicm-deploy-enviroment-env_uv_installer-UvInstaller)

### Classes

<a name="magicm-deploy-enviroment-env_uv_installer-UvInstaller"></a>
### 🅲 magicm\.deploy\.enviroment\.env\_uv\_installer\.UvInstaller
...
<a name="magicm-deploy-enviroment-env_uv_installer-UvInstaller-installed"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_uv\_installer\.UvInstaller\.installed
...
检查是否已安装
<a name="magicm-deploy-enviroment-env_uv_installer-UvInstaller-version"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_uv\_installer\.UvInstaller\.version
...
获取版本号
<a name="magicm-deploy-enviroment-env_uv_installer-UvInstaller-install"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_uv\_installer\.UvInstaller\.install
...
安装 UV
<a name="magicm-deploy-enviroment-env_uv_installer-UvInstaller-ensure"></a>
#### 🅵 magicm\.deploy\.enviroment\.env\_uv\_installer\.UvInstaller\.ensure
...
检测所有GPU
<a name="magicm-detector-hardware-gpu-gpu_detector"></a>
## 🅼 magicm\.detector\.hardware\.gpu\.gpu\_detector

- **Classes:**
  - 🅲 [GPUDetector](#magicm-detector-hardware-gpu-gpu_detector-GPUDetector)

### Classes

<a name="magicm-detector-hardware-gpu-gpu_detector-GPUDetector"></a>
### 🅲 magicm\.detector\.hardware\.gpu\.gpu\_detector\.GPUDetector
...
<a name="magicm-detector-hardware-gpu-gpu_detector-GPUDetector-__init__"></a>
#### 🅵 magicm\.detector\.hardware\.gpu\.gpu\_detector\.GPUDetector\.\_\_init\_\_

```python
def __init__(self):
```
<a name="magicm-detector-hardware-gpu-gpu_detector-GPUDetector-gpu_detected"></a>
#### 🅵 magicm\.detector\.hardware\.gpu\.gpu\_detector\.GPUDetector\.gpu\_detected
...
- `Dict`: GPU检测结果字典
<a name="magicm-detector-hardware-gpu-gpu_detector-GPUDetector-get_gpu_summary"></a>
#### 🅵 magicm\.detector\.hardware\.gpu\.gpu\_detector\.GPUDetector\.get\_gpu\_summary
...
<a name="magicm-detector-software-environment"></a>
## 🅼 magicm\.detector\.software\.environment
<a name="magicm-detector-software-environment-env_detecter"></a>
## 🅼 magicm\.detector\.software\.environment\.env\_detecter

- **Functions:**
  - 🅵 [detect](#magicm-detector-software-environment-env_detecter-detect)
  - 🅵 [get\_env\_type](#magicm-detector-software-environment-env_detecter-get_env_type)

### Functions

<a name="magicm-detector-software-environment-env_detecter-detect"></a>
### 🅵 magicm\.detector\.software\.environment\.env\_detecter\.detect
...
统一检测当前环境类型
<a name="magicm-detector-software-environment-env_detecter-get_env_type"></a>
### 🅵 magicm\.detector\.software\.environment\.env\_detecter\.get\_env\_type
...
- **Functions:**
  ...
  - 🅵 [get\_distro\_info](#magicm-detector-software-system-linux_detecter-get_distro_info)
...
检测 Linux 系统信息
<a name="magicm-detector-software-system-linux_detecter-get_distro_info"></a>
### 🅵 magicm\.detector\.software\.system\.linux\_detecter\.get\_distro\_info
...
<a name="magicm-management-config-config_loader"></a>
## 🅼 magicm\.management\.config\.config\_loader
...
- **Classes:**
  - 🅲 [ConfigLoader](#magicm-management-config-config_loader-ConfigLoader)

### Classes

<a name="magicm-management-config-config_loader-ConfigLoader"></a>
### 🅲 magicm\.management\.config\.config\_loader\.ConfigLoader
...
<a name="magicm-management-config-config_loader-ConfigLoader-__init__"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.\_\_init\_\_
...
初始化配置加载器
<a name="magicm-management-config-config_loader-ConfigLoader-get_config_path"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.get\_config\_path
...
- `Path`: 配置文件完整路径
<a name="magicm-management-config-config_loader-ConfigLoader-get_project_config_path"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.get\_project\_config\_path
...
<a name="magicm-management-config-config_loader-ConfigLoader-get_user_config_path"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.get\_user\_config\_path
...
<a name="magicm-management-config-config_loader-ConfigLoader-get_current_config_path"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.get\_current\_config\_path
...
<a name="magicm-management-config-config_loader-ConfigLoader-is_using_user_config"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.is\_using\_user\_config
...
<a name="magicm-management-config-config_loader-ConfigLoader-load"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.load
...
<a name="magicm-management-config-config_loader-ConfigLoader-load_all_from_directory"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.load\_all\_from\_directory
...
<a name="magicm-management-config-config_loader-ConfigLoader-load_merged"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.load\_merged
...
<a name="magicm-management-config-config_loader-ConfigLoader-exists"></a>
#### 🅵 magicm\.management\.config\.config\_loader\.ConfigLoader\.exists
...
<a name="magicm-management-config-config_manager"></a>
## 🅼 magicm\.management\.config\.config\_manager
...
- **Classes:**
  - 🅲 [ConfigManager](#magicm-management-config-config_manager-ConfigManager)

### Classes

<a name="magicm-management-config-config_manager-ConfigManager"></a>
### 🅲 magicm\.management\.config\.config\_manager\.ConfigManager
...
<a name="magicm-management-config-config_manager-ConfigManager-__init__"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.\_\_init\_\_
...
<a name="magicm-management-config-config_manager-ConfigManager-get_config_path"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.get\_config\_path
...
- `Path`: 完整的配置文件路径
<a name="magicm-management-config-config_manager-ConfigManager-config_exists"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.config\_exists
...
- `bool`: 配置文件存在返回 True，否则返回 False
<a name="magicm-management-config-config_manager-ConfigManager-load"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.load
...
- **FileNotFoundError**: 配置文件不存在时抛出
<a name="magicm-management-config-config_manager-ConfigManager-load_all_from_directory"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.load\_all\_from\_directory
...
- **FileNotFoundError**: 目录不存在时抛出
<a name="magicm-management-config-config_manager-ConfigManager-load_merged"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.load\_merged
...
- `Dict[str, Any]`: 合并后的配置字典
<a name="magicm-management-config-config_manager-ConfigManager-get"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.get
...
<a name="magicm-management-config-config_manager-ConfigManager-get_path"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.get\_path
...
- `Any`: 配置值
<a name="magicm-management-config-config_manager-ConfigManager-set"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.set
...
- **key**: 配置键名
- **value**: 要设置的值
<a name="magicm-management-config-config_manager-ConfigManager-set_path"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.set\_path
...
- **value**: 要设置的值
<a name="magicm-management-config-config_manager-ConfigManager-save"></a>
#### 🅵 magicm\.management\.config\.config\_manager\.ConfigManager\.save
...
<a name="magicm-management-config-config_path_manager"></a>
## 🅼 magicm\.management\.config\.config\_path\_manager
...
- **Classes:**
  - 🅲 [ConfigPathManager](#magicm-management-config-config_path_manager-ConfigPathManager)

### Classes

<a name="magicm-management-config-config_path_manager-ConfigPathManager"></a>
### 🅲 magicm\.management\.config\.config\_path\_manager\.ConfigPathManager
...
<a name="magicm-management-config-config_path_manager-ConfigPathManager-__init__"></a>
#### 🅵 magicm\.management\.config\.config\_path\_manager\.ConfigPathManager\.\_\_init\_\_
...
跳过自动查找逻辑。主要用于单元测试。
<a name="magicm-management-config-config_path_manager-ConfigPathManager-config_dir"></a>
#### 🅵 magicm\.management\.config\.config\_path\_manager\.ConfigPathManager\.config\_dir
...
<a name="magicm-management-config-config_path_manager-ConfigPathManager-get_path"></a>
#### 🅵 magicm\.management\.config\.config\_path\_manager\.ConfigPathManager\.get\_path
...
<a name="magicm-management-config-config_path_manager-ConfigPathManager-exists"></a>
#### 🅵 magicm\.management\.config\.config\_path\_manager\.ConfigPathManager\.exists
...
<a name="magicm-management-config-config_reader"></a>
## 🅼 magicm\.management\.config\.config\_reader
...
- **Classes:**
  - 🅲 [ConfigReader](#magicm-management-config-config_reader-ConfigReader)

### Classes

<a name="magicm-management-config-config_reader-ConfigReader"></a>
### 🅲 magicm\.management\.config\.config\_reader\.ConfigReader
...
<a name="magicm-management-config-config_reader-ConfigReader-__init__"></a>
#### 🅵 magicm\.management\.config\.config\_reader\.ConfigReader\.\_\_init\_\_
...
无参构造，配置在首次使用时才加载。
<a name="magicm-management-config-config_reader-ConfigReader-get"></a>
#### 🅵 magicm\.management\.config\.config\_reader\.ConfigReader\.get
...
- `Any`: 配置值，键不存在时返回 default
<a name="magicm-management-config-config_reader-ConfigReader-get_path"></a>
#### 🅵 magicm\.management\.config\.config\_reader\.ConfigReader\.get\_path
...
<a name="magicm-management-config-config_reader-ConfigReader-get_multi"></a>
#### 🅵 magicm\.management\.config\.config\_reader\.ConfigReader\.get\_multi
...
<a name="magicm-management-config-config_reader-ConfigReader-reload"></a>
#### 🅵 magicm\.management\.config\.config\_reader\.ConfigReader\.reload
...
- **module_name**: 模块名称，如 'display', 'detector'
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_reader-ConfigReader-reload_all"></a>
#### 🅵 magicm\.management\.config\.config\_reader\.ConfigReader\.reload\_all
...
<a name="magicm-management-config-config_reader-ConfigReader-get_config_source"></a>
#### 🅵 magicm\.management\.config\.config\_reader\.ConfigReader\.get\_config\_source
...
<a name="magicm-management-config-config_writer"></a>
## 🅼 magicm\.management\.config\.config\_writer
...
- **Classes:**
  - 🅲 [ConfigWriter](#magicm-management-config-config_writer-ConfigWriter)

### Classes

<a name="magicm-management-config-config_writer-ConfigWriter"></a>
### 🅲 magicm\.management\.config\.config\_writer\.ConfigWriter
...
<a name="magicm-management-config-config_writer-ConfigWriter-__init__"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.\_\_init\_\_
...
无参构造，配置在首次使用时才加载。
<a name="magicm-management-config-config_writer-ConfigWriter-get"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.get
...
- `Any`: 配置值，键不存在时返回 default
<a name="magicm-management-config-config_writer-ConfigWriter-get_path"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.get\_path
...
- `Any`: 路径对应的配置值，路径不存在时返回 default
<a name="magicm-management-config-config_writer-ConfigWriter-get_multi"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.get\_multi
...
- `Dict[str, Any]`: 键名到配置值的映射字典
<a name="magicm-management-config-config_writer-ConfigWriter-set"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.set
...
- **value**: 要设置的值
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_writer-ConfigWriter-set_path"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.set\_path
...
- **value**: 要设置的值
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_writer-ConfigWriter-update"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.update
...
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_writer-ConfigWriter-update_path"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.update\_path
...
键为点号分隔的路径，值为要设置的内容
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_writer-ConfigWriter-save"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.save
...
- `bool`: 保存成功返回 True，失败返回 False
<a name="magicm-management-config-config_writer-ConfigWriter-save_as_project"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.save\_as\_project
...
- `bool`: 保存成功返回 True，失败返回 False
<a name="magicm-management-config-config_writer-ConfigWriter-reload"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.reload
...
- **module_name**: 模块名称，如 'display', 'detector'
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_writer-ConfigWriter-reload_all"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.reload\_all
...
清空所有缓存，下次访问时会重新从文件加载。
<a name="magicm-management-config-config_writer-ConfigWriter-switch_to_user_config"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.switch\_to\_user\_config
...
- **module_name**: 模块名称，如 'display', 'detector'
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_writer-ConfigWriter-switch_to_project_config"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.switch\_to\_project\_config
...
- **module_name**: 模块名称，如 'display', 'detector'
- **config_filename**: 配置文件名，默认为 'config\.yaml'
<a name="magicm-management-config-config_writer-ConfigWriter-get_config_source"></a>
#### 🅵 magicm\.management\.config\.config\_writer\.ConfigWriter\.get\_config\_source
