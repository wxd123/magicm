...
- 🅼 [hardware\.gpu\.gpu\_detector](#hardware-gpu-gpu_detector)
...
检测所有GPU
<a name="hardware-gpu-gpu_detector"></a>
## 🅼 hardware\.gpu\.gpu\_detector

- **Classes:**
  - 🅲 [GPUDetector](#hardware-gpu-gpu_detector-GPUDetector)

### Classes

<a name="hardware-gpu-gpu_detector-GPUDetector"></a>
### 🅲 hardware\.gpu\.gpu\_detector\.GPUDetector
...
<a name="hardware-gpu-gpu_detector-GPUDetector-__init__"></a>
#### 🅵 hardware\.gpu\.gpu\_detector\.GPUDetector\.\_\_init\_\_

```python
def __init__(self):
```
<a name="hardware-gpu-gpu_detector-GPUDetector-gpu_detected"></a>
#### 🅵 hardware\.gpu\.gpu\_detector\.GPUDetector\.gpu\_detected
...
- `Dict`: GPU检测结果字典
<a name="hardware-gpu-gpu_detector-GPUDetector-get_gpu_summary"></a>
#### 🅵 hardware\.gpu\.gpu\_detector\.GPUDetector\.get\_gpu\_summary
